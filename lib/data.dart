class NewsItem {
  ...
  NewsItem({required this.title, required this.description, required this.references});
}

class AlertItem extends NewsItem {
  @override
  final String type = 'alert';
  AlertItem({required super.title, required super.description, required super.references});
}
